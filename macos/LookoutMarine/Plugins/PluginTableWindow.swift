//  PluginTableWindow.swift: one declared table, as a Mac window.
//
//  The controller owns the window, the refresh timer and the sort the mariner
//  chose. The rows and their units are PluginTableModel.swift's; this is the
//  presentation, and a phone gets PluginTableSheet.swift instead.
