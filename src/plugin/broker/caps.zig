...
pub const Cap = enum {
    ...
    pub const Carries = enum {
        ...
        /// Port numbers.
        ports,
        /// Bus topic names. An open vocabulary: the host validates the shape
        /// and never the meaning, so a new topic never needs a host change.
        topics,
    };
...
/// True when a bus grant's topic list carries this topic, exactly.
